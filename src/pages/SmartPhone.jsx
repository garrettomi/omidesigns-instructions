  ...
  return (
    <section className="page-format page-gutters">
      ...
      <p>
        ...
        <HashLink to={"#1.写真の置き換え"} className="hover:text-gray-500">
          「写真の置き換え
        </HashLink>
        」 をご覧下さい
      </p>
      ...
      <p>テンプレート内の写真・音楽を自身の素材に入れ替えたい時に使用します</p>
      <p>【iPhoneの場合】</p>
      <p>Step 1.入れ替えたい写真をクリックします</p>
      <p>Step 2.左下の置き換えのアイコンをクリックします</p>
      ...
      <p>
        著作権フリーの曲リストについては
        <Link to="/music" className="text-[#5b5bc5] underline">
          こちら
        </Link>
        をご覧ください
      </p>
      ...
      <p>Step.2 「すべてのページを表示」を選択します</p>
      <p>Step.3 「&#40;1&#41;を複製」をクリックします</p>
