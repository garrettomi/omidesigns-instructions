...
export default function Download() {
  ...
  return (
    <section className="page-gutters page-format">
      ...
      <p>作成した動画、画像を端末に保存します</p>
      <p className="mb-2">Step.1 右上の「共有」ボタンをクリックします</p>
      <div className="grid sm:grid-cols-2">
        <ContentImage
          src={firstImage}
          alt="Step 1 download instructions part 1"
        />
        <ContentImage
          src={secondImage}
          alt="Step 1 download instructions part 2"
        />
      </div>
      <p className="mb-2">Step.2 ダウンロードをクリックします</p>
      <div className="grid sm:grid-cols-2">
        <ContentImage
          src={thirdImage}
          alt="Step 2 download instructions part 1"
        />
        <ContentImage
          src={fourthImage}
          alt="Step 2 download instructions part 2"
        />
      </div>
      <p className="mb-2">
      ...
      <div className="grid sm:grid-cols-2">
        <ContentImage
          src={fifthImage}
          alt="Step 3 download instructions part 1"
        />
        <ContentImage
          src={sixthImage}
          alt="Step 3 download instructions part 2"
        />
      </div>
      <p className="mb-2">
      ...
      <div className="grid sm:grid-cols-2">
        <ContentImage
          src={seventhImage}
          alt="Step 4 download instructions part 1"
        />
        <ContentImage
          src={eighthImage}
          alt="Step 4 download instructions part 2"
        />
      </div>
      <p>※iPhoneの場合は写真フォルダに保存されます。</p>
      <SubTitle idName="DVDへの焼き方" text="DVDへの焼き方" />
      <SmallTitle idName="式場に確認すること" text="式場に確認すること" />
      <p>▪DVD種類の指定はあるか</p>
      <p className="mb-5">DVD-Rと指定される会場が多い</p>
      <p>▪1つのDVDに複数のムービーを保存していいか</p>
      <p className="mb-5">もしダメならDVDを分ける必要がある!</p>
      <p>▪︎メニュー画面が必要か</p>
      <p className="mb-5">なしと指定される場合が多い</p>
      <SmallTitle idName="おすすめのサイト" text="おすすめのサイト" />
      <p className="font-bold">【郵送】</p>
      <div>
        <Link
          to="https://dvdpaint.com/"
      ...
      <p>納期3週間、+330円で特急、16:9のみなど</p>
      <p className="mb-5">条件はありますが、安くDVD化が可能です</p>
      <p className="mb-5">そのほかminneやココナラでも外注できます</p>
      <p className="font-bold">【店舗】</p>
      <Link
        to="https://www.kitamura-print.com/data_conversion/movie_dvd/index.html"
        className="font-bold underline hover:text-[#777]"
      >
        カメラのキタムラ → 1,100円〜
      </Link>
      <p>上手く行かなかった方の例も聞いています</p>
      <p>ですが、納期がギリギリな時は即日で対応してくれる店舗がいいかも</p>
      ...
      <p>（使用されているパソコンやフリーソフトの詳細が分かりかねるため）</p>
      <p>できたDVDは問題がないかすぐ確認しましょう!</p>
      <div className="py-20">
        <ReferenceAccordion />
      </div>
      <ScrollToTop />
