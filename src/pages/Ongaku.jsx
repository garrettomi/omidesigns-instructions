...
export default function Ongaku() {
  ...
  return (
    <section className="page-format page-gutters">
      ...
      <SubTitle
        idName="テンプレートで使用している曲"
        text="テンプレートで使用している曲"
      />
      <p>テンプレートで使用している曲は著作権フリーの曲です。</p>
      <p>そのまま結婚式でご使用いただけます。</p>
      <SubTitle idName="著作権について" text="著作権について" />
      <p>
        結婚式に好きなアーティストの曲を勝手に流すと著作権で問題になってしまう可能性がございます
      </p>
      <p>式場と必要な申請等をご確認の上、曲を使用するようにしてください。</p>
      <SubTitle idName="Canva上の曲について" text="Canva上の曲について" />
      <p>Canva にある曲は全て結婚式で使用することが可能です</p>
      <p>
        詳しくは
      ...
      <p>いずれの当ショップで所有している曲ではございません。</p>
      <p>利用規約をご覧の上ご使用ください。</p>
      <p className="mb-5">
      ...
      <p>海外の方が作っているアコースティック系の曲をまとめました</p>
      <p className="mb-5">「🔽 Free MP3 Download:」からダウンロードできます</p>
      <Link
      ...
      <p className="mb-5">オルゴール専門のBGMサイト、癒し系の曲</p>
      <Link
        to="https://shw.in/"
        className="font-bold underline hover:text-[#777]"
      >
      ...
      <p>ストリーミングサービスからのアップロードはできません。</p>
      <p>PM3音楽ファイルをご用意ください。</p>
      <p>音楽のダウンロード方法はサポート外です。</p>
      <p>
