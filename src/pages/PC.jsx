...
export default function PC() {
  ...
  return (
    <section className="page-format page-gutters">
      ...
      <p>テンプレートを開くとまずこちらの画面が表示されます</p>
      <p>各アイコンについての説明は下記の通りです</p>
      <SubTitle idName="1.共有マーク" text="1.共有マーク" />
      <p>端末へのダウンロードやリンクの共有をすることが出来ます</p>
      <p>カップルで作業したい場合はこちらからリンクを共有ください</p>
      <ContentImage src={firstPhoto} alt="Step 1 for Canva Pro" />
      <SubTitle idName="2.素材" text="2.素材" />
      <p>図形やイラストなどの素材を追加することが出来ます</p>
      <p>
      ...
      <ContentImage
        src={secondPhoto}
        alt="First photo of instructions for text"
      />
      <p>
      ...
      <ContentImage
        src={thirdPhoto}
        alt="Second photo of instructions for text"
      />
      <SubTitle idName="4.アップロード" text="4.アップロード" />
      <p>ご自身のカメラロールより写真・動画・音楽を追加することが出来ます。</p>
      ...
      <p>紫のバーをクリック後、「1を削除」をクリックします</p>
      <ContentImage src={tenthPhoto} alt="Instructions for music part 3" />
      <p>音楽は別で再生する場合などに使えます</p>
      <SubTitle idName="・音楽の置き換え" text="・音楽の置き換え" />
      <p>写真の置き換えと同様です</p>
      <p>入れ替えたい音楽をドラッグすることで、音楽を変更出来ます</p>
      <SubTitle
        idName="・音楽のエフェクト（フェードイン、フェードアウト）"
        text="・音楽のエフェクト（フェードイン、フェードアウト）"
      />
      <p>右クリックでオーディオエフェクトを選択</p>
      <ContentImage
        src={eleventhPhoto}
        alt="Instructions for music effects part 1"
      />
      <p>音楽のフェードイン、フェードアウトの秒数を調整することが出来ます</p>
      <ContentImage
        src={twelfthPhoto}
        alt="Instructions for music effects part 2"
      />
      <SubTitle idName="4.ページの複製・追加" text="4.ページの複製・追加" />
      <p>
        ページの複製：クリックしたページと同じデザインのページを作成出来ます
      </p>
      <p>テンプレートのデザインを使いたい場合はこちらを使用してください</p>
      <p>ページの追加：空白のページを作成出来ます</p>
      <p>Step.1 ページの右上にある…ボタンをクリックします</p>
      <p>Step.2 「&#40;1&#41;を複製」をクリックします</p>
      <ContentImage src={thirteenthPhoto} alt="Page instructions part 1" />
      <p>
        ※Step.2
        で「ページを追加」をクリックすると空白のページを追加することが出来ます
      </p>
      <ContentImage src={fourteenthPhoto} alt="Page instructions part 2" />
      <SubTitle idName="5.アニメーション" text="5.アニメーション" />
      <p>文字や写真の出方を変更することが出来ます</p>
      <p>
        Step.1
        アニメーションを変更したいページや写真、テキストボックスをクリックします
      </p>
      <p>Step.2 丸3つが重なっているアイコンの「アニメート」をクリックします</p>
      <ContentImage src={fifteenthPhoto} alt="Animation instructions" />
      <p>Step.3 好みのアニメーションを選択します</p>
      <p>
      ...
      <p>写真の透け具合を変更することが出来ます</p>
      <p>Step.1 透明度を変更したい写真をクリックします</p>
      <p>
        Step.2
        「透明度」のアイコンをクリックすると、透明度を調節することが出来ます
      </p>
